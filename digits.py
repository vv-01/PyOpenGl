...
class Digits:
    ...
    def draw_digit(self, digit, offset_x=0, offset_y=0, digit_position_x=0):
        ...
        if int(digit) > 99:
            ...
            third_digit = int(show_digits[2])
        elif int(digit) > 9:
            first_digit = 0
            second_digit = int(show_digits[0])
            third_digit = int(show_digits[1])
        else:
            first_digit = 0
            second_digit = 0
            third_digit = int(show_digits[0])
        ...
        for i in digit_lights[third_digit]:
            i(x=digit_position_x + offset_x, y=250 + offset_y, adjust=500)
